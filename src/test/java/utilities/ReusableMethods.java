...
//   waitFor(5);  => waits for 5 second
    ...
    public static void prMrktlogInbekir(){

        PearlyMarketPage PearlyMarketPage = new PearlyMarketPage();
        PearlyMarketPage.signinbutton.click();
        PearlyMarketPage.username.sendKeys("bsacikara88@gmail.com");
        PearlyMarketPage.password.sendKeys("Bs200400.");
        ...
        PearlyMarketPage.signOut.click();
    }
    //======================STORE_MANAGER======================================
